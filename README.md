...
* **Boundary (Repositório):** Camada responsável pelo acesso aos dados via **JDBC Puro**.
...
* **Visualização Gráfica da Grade:** Exibição das disciplinas organizadas por semestres em formato de mapa.
* **Código de Cores:**
    * 🟢 **Verde:** Aprovado
...
* **Ferramentas de Análise:** Visualização da justificativa e verificação de professores disponíveis por área.
...
2.  Execute o script completo localizado em: `BD_SistemaAuxilioOrientador.sql` (na raiz do projeto) para criar as tabelas e popular com dados de teste.
...
| Tela Inicial | Grade Visual |
|:---:|:---:|
| \<img src="docs/tela\_inicial.png" width="400"\> | \<img src="docs/grade.png" width="400"\> |

| Solicitações Especiais | Agendamentos |
|:---:|:---:|
| \<img src="docs/solicitacoes.png" width="400"\> | \<img src="docs/agenda.png" width="400"\> |
